...
if __name__ == '__main__':
    ...
    AllProtein = []
    ReadMyCsv1(AllProtein, 'RICE_LIST_sequence.csv')    #
    ProteinEmbedding = []
    ...
    while CounterT < 4:
        ...
        x1 = Conv2D(48, kernel_size=(4, 64), activation='relu', name='conv1')(input1)
        ...
        # x3 = Dense(124, activation='relu', activity_regularizer=regularizers.l2(0.001))(input3)
        # x3 = Dropout(rate=0.2)(x3)
        # # ——输入4——
        # input4 = Input(shape=(len(x_train_2_Behavior[0]),), name='input4')
        # x4 = Dense(98, activation='relu', activity_regularizer=regularizers.l2(0.001))(input4)
        ...
        # hidden = Dropout(rate=0.7)(hidden)
