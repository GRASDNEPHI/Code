...
while counter0 < 5:
    ...
    RAPName = 'dw_RealAndPredictionA+B'+ str(counter0) + '.csv'
    RAPNameProb = 'dw_RealAndPredictionProbA+B'+ str(counter0) + '.csv'
...
plt.plot(mean_fpr, mean_tpr, color='blue',
         label=r'deepwalk+DNN (AUC = 0.8633)' % (mean_auc),
         lw=2, alpha=1)
...
while counter0 <5:
    ...
    RealAndPrediction = []
    RealAndPredictionProb = []
    RAPName = 'line_RealAndPredictionA+B'+ str(counter0) + '.csv'
    RAPNameProb = 'line_RealAndPredictionProbA+B'+ str(counter0) + '.csv'
    ReadMyCsv(RealAndPrediction, RAPName)
    ReadMyCsv(RealAndPredictionProb, RAPNameProb)
    # 生成Real和Prediction
    Real = []
...
plt.plot(mean_fpr, mean_tpr, color='green',
         label=r'Line+DNN (AUC = 0.8890)' % (mean_auc),
         lw=2, alpha=1)
...
while counter0 < 5:
    ...
    RealAndPrediction = []
    RealAndPredictionProb = []
    RAPName = 'hope_RealAndPredictionA+B'+ str(counter0) + '.csv'
    RAPNameProb = 'hope_RealAndPredictionProbA+B'+ str(counter0) + '.csv'
    ReadMyCsv(RealAndPrediction, RAPName)
    ReadMyCsv(RealAndPredictionProb, RAPNameProb)
    # 生成Real和Prediction
    Real = []
...
while counter < len(mean_fpr3):
    ...
    FprAndTpr.append(pair)
    counter = counter + 1
plt.plot(mean_fpr3, mean_tpr3, color='gold',
         label=r'hope+DNN (AUC = 0.8684)' % (mean_auc3),
         lw=2, alpha=1)
...
while counter0 < 3:
    ...
    RealAndPrediction = []
    RealAndPredictionProb = []
    RAPName = 'lap_RealAndPredictionA+B'+ str(counter0) + '.csv'
    RAPNameProb = 'LAP_RealAndPredictionProbA+B'+ str(counter0) + '.csv'
    ReadMyCsv(RealAndPrediction, RAPName)
    ReadMyCsv(RealAndPredictionProb, RAPNameProb)
    # 生成Real和Prediction
    Real = []
...
plt.plot(mean_fpr, mean_tpr, color='red',
         label=r'Lap+DNN (AUC = 0.8690)' % (mean_auc),
         lw=2, alpha=1)
...
while counter0 < 5:
    ...
    RealAndPrediction = []
    RealAndPredictionProb = []
    RAPName = 'our_RealAndPredictionA+B' + str(counter0) + '.csv'
    RAPNameProb = 'our_RealAndPredictionProbA+B' + str(counter0) + '.csv'
    ReadMyCsv(RealAndPrediction, RAPName)
    ReadMyCsv(RealAndPredictionProb, RAPNameProb)
    # 生成Real和Prediction
    Real = []
    ...
    counter0 = counter0 + 1
# 画均值
mean_tpr5 = np.mean(tprs, axis=0)
mean_tpr5[-1] = 1.0
mean_auc5 = auc(mean_fpr, mean_tpr5)
std_auc = np.std(aucs)
print('mean_fpr5', mean_fpr)
print('mean_tpr5', mean_tpr)
FprAndTpr = []
counter = 0
while counter < len(mean_fpr):
    pair = []
    ...
    FprAndTpr.append(pair)
    counter = counter + 1
plt.plot(mean_fpr, mean_tpr5, color='black',
         label=r'Our Method (AUC = 0.9208)' % (mean_auc),
         lw=2, alpha=1)

#-------------------------------------------------------------------------------------------------#
# # 放大
# MyEnlarge(0, 0.7, 0.25, 0.25, 0.5, 0, 2, mean_fpr,  mean_tpr,  2, colorlist[i])
