...
while counter0 < 5:
    ...
    RAPName = 'dw_RealAndPredictionA+B0.csv'
    RAPNameProb = 'dw_RealAndPredictionProbA+B0.csv'
...
print(mean_RPs1)
std_RPs = np.std(RPs1)
plt.plot(mean_P1, mean_R1, color='blue',
         label=r'Deepwalk+DNN (AUPR = %0.4f)' % (mean_RPs1),
         lw=2, alpha=1)
...
while counter0 < 5:
    ...
    RealAndPrediction = []
    RealAndPredictionProb = []
    RAPName = 'line_RealAndPredictionA+B0.csv'
    RAPNameProb = 'line_RealAndPredictionProbA+B0.csv'
    ReadMyCsv(RealAndPrediction, RAPName)
    ReadMyCsv(RealAndPredictionProb, RAPNameProb)
    # 生成Real和Prediction
    Real = []
...
print(mean_RPs2)
std_RPs = np.std(RPs2)
plt.plot(mean_P2, mean_R2, color='green',
         label=r'Line+DNN (AUPR = %0.4f)' % (mean_RPs2),
         lw=2, alpha=1)
...
while counter0 < 5:
    ...
    RealAndPrediction = []
    RealAndPredictionProb = []
    RAPName = 'hope_RealAndPredictionA+B4.csv'
    RAPNameProb = 'hope_RealAndPredictionProbA+B4.csv'
    ReadMyCsv(RealAndPrediction, RAPName)
    ReadMyCsv(RealAndPredictionProb, RAPNameProb)
    # 生成Real和Prediction
    Real = []
...
print(mean_RPs3)
std_RPs = np.std(RPs3)
plt.plot(mean_P3, mean_R3, color='gold',
         label=r'Hope+DNN (AUPR = %0.4f)' % (mean_RPs3),
         lw=2, alpha=1)
...
while counter0 < 5:
    ...
    RealAndPrediction = []
    RealAndPredictionProb = []
    RAPName = 'lap_RealAndPredictionA+B0.csv'
    RAPNameProb = 'lap_RealAndPredictionProbA+B0.csv'
    ReadMyCsv(RealAndPrediction, RAPName)
    ReadMyCsv(RealAndPredictionProb, RAPNameProb)
    # 生成Real和Prediction
    Real = []
...
print(mean_RPs4)
std_RPs = np.std(RPs4)
plt.plot(mean_P4, mean_R4, color='red',
         label=r'Lap+DNN (AUPR = %0.4f)' % (mean_RPs4),
         lw=2, alpha=1)
...
print(mean_RPs5)
std_RPs = np.std(RPs5)
plt.plot(mean_P5, mean_R5, color='black',
         label=r'Our Method (AUPR = %0.4f)' % (mean_RPs5),
         lw=2, alpha=1)
...
plt.ylim([-0.001, 1.002])
plt.xlim([-0.001, 1.002])
