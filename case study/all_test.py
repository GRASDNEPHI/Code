...
if __name__ == '__main__':
    ...
    AllNodeBehavior1 = []
    ReadMyCsv1(AllNodeBehavior1, 'All_phi_SDNE64.csv')
    ...
    ReadMyCsv1(PositiveSample_Train, 'PositiveSample_Train_phi.csv')
    PositiveSample_Validation = []
    ReadMyCsv1(PositiveSample_Validation, 'PositiveSample_Validation_phi.csv')
    PositiveSample_Test = []
    ReadMyCsv1(PositiveSample_Test, 'phi test date_Sta.csv')

    NegativeSample_Train = []
    ReadMyCsv1(NegativeSample_Train, 'NegativeSample_Train_phi.csv')
    NegativeSample_Validation = []
    ReadMyCsv1(NegativeSample_Validation, 'NegativeSample_Validation_phi.csv')
    NegativeSample_Test = []
    ReadMyCsv1(NegativeSample_Test, 'NegativeSample_Test_case_sta.csv')
