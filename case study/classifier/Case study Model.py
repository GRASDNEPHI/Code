...
if __name__ == '__main__':
    # ker+MACCSfp
    AllNodeBehavior = pd.read_csv(r'../topological/all RNAInter_BINE64.csv', header=None).values.tolist()
    ...
    PositiveSample_Train = pd.read_csv(r'../Negative samples/Allpositive Training Validation/PositiveSample_Train.csv', header=None).values.tolist()
    PositiveSample_Validation = pd.read_csv(
        r'../Negative samples/Allpositive Training Validation/PositiveSample_Validation.csv', header=None).values.tolist()
    NegativeSample_Train = pd.read_csv(r'../Negative samples/Allpositive Training Validation/NegativeSample_Train.csv', header=None).values.tolist()
    NegativeSample_Validation = pd.read_csv(
        r'../Negative samples/Allpositive Training Validation/NegativeSample_Validation.csv', header=None).values.tolist()
    #CaseStudy Test
    casestudy_test = pd.read_csv(r'../Negative samples/Allpositive Training Validation/cs global test.csv', header=None).values.tolist()
